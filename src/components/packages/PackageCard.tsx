        ...
        {/* <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="px-3 py-2 text-sm border border-primary text-primary rounded-lg cursor-pointer hover:bg-primary hover:text-white transition-all font-medium"
            >
              Details
            </Link>
            <Link
              href={`/contact?package=${pkg.id}`}
              className="px-3 py-2 text-sm bg-secondary text-white rounded-lg cursor-pointer hover:bg-secondary-dark transition-all font-medium"
            >
              Book
            </Link>
          </div>
